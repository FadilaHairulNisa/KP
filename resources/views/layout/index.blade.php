      ...
      <div>
        <div class="brand-logo d-flex align-items-center justify-content-between">
          <a href="index.html" class="text-nowrap logo-img">
            <img src="{{ asset('images/logos/bpslogo.png') }}" width="220" alt="" />
          </a>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false">
                <span>
            ...
            {{-- <li class="sidebar-item">
              <a class="sidebar-link" href="/status" aria-expanded="false">
                ...
                <span class="hide-menu">Status Produksi</span>
              </a>
            </li>
            </li>
            <li class="sidebar-item">
